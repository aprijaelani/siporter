                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="no_identitas_sediaan_dahak" id="no_identitas_sediaan_dahak" class="form-control" value="{{$data->no_identitas_sediaan_dahak}}">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">BPJS</label>
                          <input type="text" name="bpjs" class="form-control" value="{{$data->bpjs}}">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Tanggal Didaftar</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_didaftar}}" id="datepicker" name="tanggal_didaftar">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_lahir}}" name="tanggal_lahir">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Berat Badan</label>
                          <input type="text" class="form-control" value="{{$data->berat_badan}}" name="berat_badan">
                        </div>                              
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label style="color:black;">Tinggi Badan</label>
                          <input type="text" class="form-control" value="{{$data->tinggi_badan}}" name="tinggi_badan">
                        </div>
                        <div class="form-group" style="margin-bottom: -5px;">
                          <label style="color:black;">Jenis Kelamin</label>
                          <div class="radio">
                              <label style="color: black; margin-right: 50px;margin-left: -10px;">
                                  <input type="radio" name="jenis_kelamin" class="flat-red" value="pria" {{ $data->jenis_kelamin == 'pria' ? 'checked' : '' }}>Pria
                              </label>
                              <label style="color: black;">
                                <input type="radio" name="jenis_kelamin" class="flat-red" value="wanita" {{ $data->jenis_kelamin == 'wanita' ? 'checked' : '' }}>Wanita
                              </label>
                          </div>
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Jika Wanita Usia Subur</label>
                          <select name="wanita_usia_subur" class="form-control">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select name="dirujuk_oleh" class="form-control select2">
                            <option value="">Pilih</option>
                        ...
                        <div class="form-group">
                          ...
                          <select name="lokasi_anatomi_penyakit" class="form-control select2">
                            <option value="">Pilih</option>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{$data->total_skoring_tb_anak}}" name="total_skoring_tb_anak">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Foto Toraks</label>
                          <input type="text" class="form-control" value="{{$data->foto_toraks}}" name="foto_toraks">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Status HIV</label>
                          <input type="text" class="form-control" value="{{$data->status_hiv}}" name="status_hiv">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Riwayat Diabetes Melitus</label>
                          <input type="text" class="form-control" value="{{$data->riwayat_diabetes_melitus}}" name="riwayat_diabetes_melitus">
                        </div>                      
                      </div>
                      <div class="col-md-6">
                         <div class="form-group">
                          <label style="color:black;">A Sewaktu</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_a}}" name="tanggal_a">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">B Pagi</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_b}}" name="tanggal_b">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">C Sewaktu</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_c}}" name="tanggal_c">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Hasil A</label>
                          <input type="text" class="form-control" value="{{$data->hasil_a}}" name="hasil_a">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Hasil B</label>
                          <input type="text" class="form-control" value="{{$data->hasil_b}}" name="hasil_b">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Hasil C</label>
                          <input type="text" class="form-control" value="{{$data->hasil_c}}" name="hasil_c">
                        </div>                        
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_expert}}" name="tanggal_expert">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Tanggal Mikroskopis</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_mikroskopis}}" name="tanggal_mikroskopis">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Hasil Expert</label>
                          <input type="text" class="form-control" value="{{$data->hasil_expert}}" name="hasil_expert">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Tanggal Biakan</label>
                          <input type="text" class="form-control datepicker" value="{{$data->tanggal_biakan}}" name="tanggal_biakan">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label style="color:black;">Hasil Biakan</label>
                          <input type="text" class="form-control" value="{{$data->hasil_biakan}}" name="hasil_biakan">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">No. Reg. Lab</label>
                          <input type="text" class="form-control" value="{{$data->no_reg_lab}}" name="no_reg_lab">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Tanggal Mulai Pengobatan</label>
                          <input type="text" class="form-control  datepicker" value="{{$data->tanggal_mulai_pengobatan}}" name="tanggal_mulai_pengobatan">
                        </div>
                        <div class="form-group">
                          <label style="color:black;">Dirujuk Ke</label>
                          <input type="text" class="form-control" value="{{$data->dirujuk_ke}}" name="dirujuk_ke">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
